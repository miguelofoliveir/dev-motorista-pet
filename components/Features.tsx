              ...
              <ScrollAnimation variants={leftVariants}>
                ...
                <div className="pt-4">
                  <details>
                    ...
                    <p className="regular-16  pt-2">
                      R: Cachorros: pequenos até 4, médios até 3, grandes até 2
                      e gigantes apenas 1. <br />
                ...
                <div className="pt-4">
                  <details>
                    ...
                    <p className="regular-16  pt-2">
                      Recomendamos que não alimente seu pet 1 hora antes da
                      viagem para evitar que ele se sinta mal ou desconfortável
                      durante a viagem.
                    </p>
                  </details>
                </div>
                <div className="pt-4">
                  <details>
                    ...
                    <p className="regular-16  pt-2">
                      Sim, entre em contato com a nossa Central para avaliarmos
                      a sua necessidade.
                    </p>
                  </details>
                </div>
                ...
                <div className="pt-4">
                  <details>
                    ...
                    <p className="regular-16  pt-2">
                      ...
                      devolvido.
                      <br />
                      Até uma hora antes haverá cobrança de 40% do valor por
                      conta do impacto na agenda do motorista e pelo seu
                      deslocamento já iniciado. <br />
                ...
                <div className="pt-4">
                  <details>
                    ...
                    <p className="regular-16  pt-2">
                      ...
                      conseguiremos atender sua solicitação imediatamente, mas
                      não garantimos disponibilidade de motoristas.
                    </p>
                  </details>
                </div>
                <div className="pt-4">
                  <details>
                    ...
                    <p className="regular-16  pt-2">
                      ...
                      própria capa de proteção. Caso haja uma intercorrência
                      onde a sujeira entre em contato com o carpete e/ou bancos
                      e não seja possível a higienização convencional,
                      cobraremos uma taxa simbólica de limpeza.
                    </p>
                  </details>
                </div>
              </ScrollAnimation>
